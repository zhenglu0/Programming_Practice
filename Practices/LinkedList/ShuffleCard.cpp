...
//  ShuffleCard.cpp
//  
//  Modified by 罗铮 on 11/02/13.
//  A C++ Program to Shuffle Cards
...
/*
 step2. Take the next card off the top and put it on the 
 bottom of the deck in your hand.
*/
...
/*
 ...
 2. Take the next card off the top and put it on the bottom of 
    the deck in your hand.
 3. Continue steps 1 and 2 until all cards are on the table.  
    This is a round.
 4. Pick up the deck from the table and repeat steps 1-3 until 
    the deck is in the original order.
    This program returns the number of rounds necessary to get back 
    to the original deck. We start with a deck (which we call the 
    primary deck) with head aHead and tail aTail.  We make a copy 
    of the primary deck so that we can manipulate it and compare to 
    the original deck.  We carry out steps 1-2 and represent the 
    cards on the table as the /secondary deck/.  Then we set the primary 
    deck copy to the secondary deck and repeat until the secondary 
    deck equals the original primary deck.
 */
...
int main (int argc, char *argv[])
{
    ...
    if (argc == 2)
        ...
        printf("There should be one argument pass to "
                "the main function!!! \n");
    // Initialize the Deck
    while (i < numCards) {
