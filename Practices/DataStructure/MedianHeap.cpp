...
//  
//  This problem can be also solved with the skiplist too
//  Just keep a index pointed to the median
//  Maybe even a little easier than heap

//  We can also use the #include <queue>  // std::priority_queue
//  However this implementation of heap is worth reading
...
// exchange a and b
// the inline function can make it faster
...
// Heap implementation
// The min or max heap will inherit from the heap
