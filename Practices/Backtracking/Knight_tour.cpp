...
/* A utility function to check if i,j are valid indexes for 
   N*N chessboard */
...
It returns false if
no complete tour is possible, otherwise return true and prints 
the tour.
